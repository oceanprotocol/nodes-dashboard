...
const AuthoringPanel = ({ authToken, consumerAddress }: AuthoringPanelProps) => {
  ...
  const currentCurated = CURATED_IMAGES.find((c) => curatedImageRef(c) === dockerImage) ?? CURATED_IMAGES[0];
  ...
  const imageSelectValue =
    imageSource === 'default' ? curatedOptionValue(currentCurated.repo) : imageSource || undefined;
                    ...
                    <div className={styles.optionRow}>
                      <div className={styles.optionText}>
                        ...
                        <span className={styles.optionDesc}>
                          {IMAGE_OPTIONS.find((x) => x.value === o.value)?.desc}
                        </span>
                      </div>
              ...
              <div className={styles.section}>
                ...
                >
                  ...
                  <span className={styles.dropzoneHint}>
                    Extra files for the Docker build context (e.g. requirements.txt).
                  </span>
                </div>
                {Object.keys(additionalDockerFiles).length > 0 && (
              ...
              <div className={styles.entryPanel}>
                ...
                <div className={styles.entryGrid}>
                  {[
                    {
                      id: 'algo' as const,
                      title: 'Run my algorithm',
                      desc: 'The node injects your code as $ALGO and runs it. Algorithm required.',
                    },
                    {
                      id: 'self' as const,
                      title: 'Image is self-contained',
                      desc: 'Your entrypoint runs code baked into the image. Algorithm becomes optional.',
                    },
                  ].map((e) => (
                    <button
                      key={e.id}
                  ...
                  <div className={styles.imageRow}>
                    <div className={styles.imageCol}>
                      <Input
                        ...
                        errorText={
                          attempted[0] === 1 && selfContained && !entrypoint.trim()
